...
import { Card, Form, Button, Input, Checkbox, Radio, Select, Switch, DatePicker, TimePicker, upload, Icon, message, InputNumber, Upload } from 'antd'
        ...
        <Card title="注册表单">
          <Form layout="horizontal">
            ...
            <FromItem label="头像" {...formItemLayout}>
              {
                getFieldDecorator('userImg')(
                  <Upload listType="picture-card" showUploadList={false} action="//jsonplaceholder.typicode.com/posts/" onChange={this.handleChange}>{this.state.userImg ? <img src={this.state.userImg} alt="" /> : <Icon type="plus" />}</Upload>
                )
              }
            </FromItem>
            <FromItem {...offsetLayout}>
              {
                getFieldDecorator('userImg')(
                  <Checkbox>我已阅读过<a href="javascript: void(0)">慕课协议</a></Checkbox>
                )
              }
            </FromItem>
            <FromItem {...offsetLayout}>
